        ...
        <div class="menu-container">
            ...
            <div class="menu-content">
                <ul>
                    ...
                    <li><a href="#" class="menu-link">Vacatures</a><i class="fas fa-arrow-right"></i></li>
    ...
    <main class="logincaontainer">
        <div class="login">
            <p class="errormsg" style='color:red'>
                <?php
                    if (isset($_SESSION['register_failed_exist'])) {
                        echo "Gebruikersnaam of e-mail bestaat al.";
                        unset($_SESSION['register_failed_exist']);
                    }
                    ...
                    if (isset($_SESSION['register_failed_empty'])) {
                        echo "Alle velden moeten worden ingevuld.";
                        unset($_SESSION['register_failed_empty']);
                    }

                    if (isset($_SESSION['register_failed_mismatch'])) {
                        echo "Wachtwoorden komen niet overeen.";
                        unset($_SESSION['register_failed_mismatch']);
                    }

                    if (isset($_SESSION['register_failed_phone'])) {
                        echo "Telefoonnummer moet beginnen met +3106.";
                        unset($_SESSION['register_failed_phone']);
                    }

                    if (isset($_SESSION['register_failed_length'])) {
                        echo "Wachtwoord moet minimaal 8 karakters bevatten.";
                        unset($_SESSION['register_failed_length']);
                    }
            ...
            <form class="loginform" action="./controllers/account_controller.php?type=register" method="POST" autocomplete="on">
                ...
                <label for="phone" class="order-phone seper">
                    <input class="order-input valued-input" type="text" name="phone" id="phone" value="+31 " required autocomplete="tel">
