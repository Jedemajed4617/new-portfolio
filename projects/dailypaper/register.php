...
<body>
    <section class="navie">
        <section class="navBar section">
            <section class="navBarLinks section">
                <section class="navBarLogo section">
                    <a class="navImgLogo" href="./index.html"><img id="imgHeader" class="imgLogoHead" src="/img/PhoneLogo.webp" alt=""></a>
                    <a class="navLogoLink section" href="./index.html">Daily Paper</a>
                </section>
                <section class="navBarLinkc section">
                    <a class="navBarLink hover-underline-animation section" href="">Men</a>
                    <a class="navBarLink hover-underline-animation section" href="">Women</a>
                    <a class="navBarLink hover-underline-animation section" href="">Accessories</a>
                </section>
            </section>
        </section>
        <section class="navBarSection section">
            ...
            <a href="#" class="navBarProfile section" onclick="<?php if(!isset($_SESSION['username'])) { echo 'window.location.href = \'login.php\';'; } else { echo 'window.location.href = \'profile.php\';'; } ?>"><i class="fa-regular fa-user"></i></a>
            <a href="cart.php" class="navBarShop section"><i class="fa-solid fa-cart-shopping"></i></a>
        </section>
    </section> 

    <section class="RegisterContent">
        <h1 style="text-align: center; font-size: 3rem; padding-top: 5rem;">Register an account!</h1>
        <div class="peetje8">
            <form name="f1" class="RegisterForm" action="createuser.php" method="POST">
                <p>Email:</p>
                <input class="emailInput" type="email" name="email" id="email" placeholder="E-mail">
                <p>Password:</p>
                <input class="passInput" type="password" name="pass" id="pass" placeholder="Password">
                <p>Repeat Password:</p>
                <input class="passInput" type="password" name="pass2" id="pass" placeholder="Password">
                <p>Choose a Username:</p>
                <input class="userInput" type="text" name="user" id="user" placeholder="Username">
                <button id="btn" type="submit">Register</button>
                <p class="petra">Already have an account? Login <a href="login.php">here</a></p>
